    ...
    public partial class Process
    {
        ...
        void WriteUserMem(int ch, int res)
        {
            try
            {
                ...
                xWriteData[1] = (byte)(Math.Round(PassFails[ch].Results[(int)SpecItem.OISX_Ratedstroke].Val / 4.0, MidpointRounding.AwayFromZero));
                //xWriteData[2] = 0; //OC
                //xWriteData[3] = 0; //OC
                xWriteData[4] = 0x01;
                ...
                yWriteData[1] = (byte)(Math.Round(PassFails[ch].Results[(int)SpecItem.OISY_Ratedstroke].Val / 4.0, MidpointRounding.AwayFromZero));
                //yWriteData[2] = 0; //OC
                //yWriteData[3] = 0; // OC
                yWriteData[4] = 0x01;
